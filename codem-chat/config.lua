...
Config.PresetChatThemes = {
    ...
    ems = {
        ...
        useAuthorPrefix = true,
        chatBetweenJobs = true, -- if you set this to false everyone will see the message if true only players with ambulance job will see the message
    ...
    lspd = {
        ...
        chatBetweenJobs = true, -- if you set this to false everyone will see the message if true only players with police job will see the message
        useAuthorPrefix = true,
    ...
    admin = {
        ...
        useAuthorPrefix = true,
        chatBetweenAdmins = false, -- if you set this to false everyone will see the message if true only admins will see
