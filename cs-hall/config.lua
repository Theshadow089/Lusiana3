config = {
    ...
    ['lang'] = {
        ...
        ['bassSmoke'] = 'Bass-Rauch',
        ['bassSparklers'] = 'Bass-Wunderkerzen',
        ['triggerSmoke'] = 'Rauch auslösen',
        ['triggerSparklers'] = 'Wunderkerzen auslösen',
        ['whiteSpotlights'] = 'Weiße Scheinwerfer',
        ['dynamicSpotlights'] = 'Dynamische Scheinwerfer',
        ['photorythmicSpotlights'] = 'Photorythmische Scheinwerfer',
        ['videoToggle'] = 'Video umschalten',
        ['screenControl'] = 'Bildschirmsteuerung',
        ['remoteControl'] = 'Fernbedienung',
        ['play'] = 'Spielen',
        ['queueNow'] = 'Jetzt anschalten',
        ['queueNext'] = 'Nächstes',
        ['remove'] = 'Entfernen',
        ['pause'] = 'Pause',
        ['stop'] = 'Stop',
        ...
        ['loop'] = 'Schleife',
        ['volume'] = 'Volumen',
        ['invalidUrl'] = 'URL ungültig.',
        ['invalidYouTubeUrl'] = 'YouTube URL ungültig.',
        ['invalidTwitchUrl'] = 'Twitch URL ungültig.',
        ['urlPlaceholder'] = 'YouTube / Twitch URL',
        ['sourceError'] = 'Fehler bei abspielbaren Medien aufgetreten.',
        ['twitchChannelOffline'] = 'Twitch Kanal offline.',
        ['twitchVodSubOnly'] = 'Nur Twitch-Video-Abonnenten.',
        ['twitchError'] = 'Twitch-Fehler aufgetreten.',
        ['youtubeError'] = 'YouTube-Fehler aufgetreten.',
        ['sourceNotFound'] = 'Abspielbare Medien werden nicht gefunden.',
        ['liveFeed'] = 'Live Feed',
        ['twitchClip'] = 'Twitch Clip',
        ['queueLimitReached'] = 'Die Warteschlange hat bereits zu viele Einträge.',
        ['scenes'] = 'Szenen'
    },
